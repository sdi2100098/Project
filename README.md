...
## Σύντομη Περιγραφή / Γενική Επισκόπηση Έργου

Στόχος της εργασίας είναι η υλοποίηση και αξιολόγηση αλγορίθμων Αναζήτησης Εγγύτερων Γειτόνων (ANN) πάνω σε γράφους, με έμφαση στην οικογένεια Vamana και στην υποστήριξη φίλτρων. Πιο συγκεκριμένα, το project κατασκευάζει ευρετήρια γράφων για αποδοτική αναζήτηση σε διανυσματικά δεδομένα και μετρά την ποιότητα των αποτελεσμάτων (recall/accuracy) σε σχέση με ground truth.

Υλοποιήθηκαν οι βασικοί αλγόριθμοι GreedySearch, RobustPrune και Vamana, καθώς και οι επεκτάσεις τους FilteredGreedySearch, FilteredRobustPrune, FilteredVamana και StitchedVamana. Επιπλέον, υλοποιήθηκαν εργαλεία προεπεξεργασίας για δημιουργία binary αρχείων (ground truth, αποστάσεις, γράφος), μηχανισμός αποθήκευσης/φόρτωσης γράφου σε binary μορφή, εκτελέσιμα για κατασκευή ευρετηρίου και για υπολογισμό recall, καθώς και unit tests και έλεγχοι με valgrind για ορθότητα και αξιοπιστία.

Συνολικά, το έργο καλύπτει όλη τη ροή: από την ανάγνωση δεδομένων και την κατασκευή γράφου ANN, μέχρι την πειραματική αξιολόγηση (χρόνος και ποιότητα αναζήτησης) με παραμετροποίηση μέσω config αρχείου.
