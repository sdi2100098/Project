...
test_all: $(OBJ_DIR)/RandomPermutation.o $(OBJ_DIR)/EuclidianDistance.o $(OBJ_DIR)/GetRandomNumber.o $(OBJ_DIR)/Set_Difference.o $(OBJ_DIR)/Read_Vector.o $(OBJ_DIR)/Delete_Graph.o $(OBJ_DIR)/MultiThread.o $(OBJ_DIR)/Test_All.o
	g++ -pthread -o run_all_tests $(OBJ_DIR)/RandomPermutation.o $(OBJ_DIR)/EuclidianDistance.o $(OBJ_DIR)/GetRandomNumber.o $(OBJ_DIR)/Set_Difference.o $(OBJ_DIR)/Read_Vector.o $(OBJ_DIR)/Delete_Graph.o $(OBJ_DIR)/MultiThread.o $(OBJ_DIR)/Test_All.o -I$(INC_DIR) -I$(TEST_DIR) -lm
	./run_all_tests
