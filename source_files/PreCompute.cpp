...
*/
   ...
   // Open the JSON configuration file
    ...
    if(CreateKNNGraphBruteForce(&G,&Q,k,output_path,binary_output_path) == 1) goto precompute_error;
    

    if(Graph_Graph_Dinstance_Precompute(&G) == 1) goto precompute_error;

    if(Graph_Query_Dinstance_Precompute(&G,&Q) == 1) goto precompute_error;
