...
void Set_Difference(std::set<std::pair<float, int>> *L, std::set<int> *V, std::set<int> *Difference_Set)
{

    for (std::set<std::pair<float, int>>::iterator it = L->begin(); it != L->end(); it++)
    {
